...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        let listingIDs=movieIDs.concat(seriesIDs)
        listingIDs.map((val,i,arr)=>{
                let singleMovieList;
                if(arr.length-1==i){
                    fetchMovie(val,true)
